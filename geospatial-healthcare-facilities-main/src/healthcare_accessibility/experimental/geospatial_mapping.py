"""
Script for visualising healthcare facilities on an interactive map. 

- Adds admin boundaries
- Breakdown by facility type

Run:
    Requires src\healthcare_accessibility\data_cleaning_and_merging.py to generate cleaned_hcf data
"""
# %%
# Import packages
import folium
