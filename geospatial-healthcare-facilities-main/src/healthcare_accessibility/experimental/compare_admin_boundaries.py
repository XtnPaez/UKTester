"""
Compares administrative boundaries for Malawi at multiple levels from different providers.
This includes generation of interactive maps.

Uses:
    data\Admin Boundaries
"""
