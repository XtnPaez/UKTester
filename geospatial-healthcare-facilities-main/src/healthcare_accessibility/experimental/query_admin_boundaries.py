"""
Script for retrieval of admin boundaries and roads from OSM.

Struggles for Regions and Authorities.

Dependant on cleaned_hcf dataset from: src\healthcare_accessibility\data_cleaning_and_merging.py
"""
