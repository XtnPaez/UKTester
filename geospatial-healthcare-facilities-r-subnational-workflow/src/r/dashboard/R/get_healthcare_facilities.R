...
get_healthcare_facilities_malawi <- function(
  ...
  healthcare <- readxl::read_xlsx(tmp, sheet = "Facilities") |>  # TODO: Malawi specific, need to decide how to handle extra filtering for other contexts
    dplyr::filter(STATUS == "Functional") |>  # TODO: Malawi specific
